					...
					success : function(result2) {
						...
						$("#PBTC").html(
								pbtc_c
										...
										+ (obj.USDT_BTC.percentChange * 100)
												.toFixed(2) + "%" + ")</div>");
						$("#PETH").html(
								peth_c
										+ "    <div style='float:right;'>("
										+ (obj.USDT_ETH.percentChange * 100)
												.toFixed(2) + "%" + ")</div>");
						$("#PDASH").html(
								pdash_c
										+ "    <div style='float:right;'>("
										+ (obj.USDT_DASH.percentChange * 100)
												.toFixed(2) + "%" + ")</div>");
						$("#PLTC").html(
								pltc_c
										+ "    <div style='float:right;'>("
										+ (obj.USDT_LTC.percentChange * 100)
												.toFixed(2) + "%" + ")</div>");
						$("#PETC").html(
								petc_c
										+ "    <div style='float:right;'>("
										+ (obj.USDT_ETC.percentChange * 100)
												.toFixed(2) + "%" + ")</div>");
						$("#PXRP").html(
								pxrp_c
										+ "    <div style='float:right;'>("
										+ (obj.USDT_XRP.percentChange * 100)
												.toFixed(2) + "%" + ")</div>");
							...
							if (btc_c > pbtc_c) {
								...
								$("#BTC_p")
										.html(
												tempval.toFixed(2)
														+ "%"
														+ "    (bithumb <i class='fa fa-arrow-up' style='font-size:26px; color:green;'></i>)");
							} else {
								...
								$("#BTC_p")
										.html(
												tempval.toFixed(2)
														+ "%"
														+ "   (poloniex <i class='fa fa-arrow-up' style='font-size:26px; color:green;'></i>)");
							}
						}
